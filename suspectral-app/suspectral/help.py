        ...
        browser.setHtml(f"""
            <html>
              ...
              <body>
                ...
                <h2>Spectral Plots</h2>
                <p>
                  The Spectral Plots area displays the spectra of the currently selected pixels, either individually or
                ...
                <p><strong>NPy.</strong> The spectra are saved as a NumPy array file containing the spectra and wavelengths (if present) as a single
                  multidimensional array of shape (N × M), N is the number of selected pixels (+ 1 if wavelengths are present) and M is the number of spectral bands in the hypercube.
                </p>
                </p>
                <p><strong>MATLAB.</strong> The spectra are saved as a MATLAB file containing two variables: spectra and wavelengths (if present). The spectral matrix is of shape (N × M), where N is the number of selected pixels and M is the number of spectral bands in the hypercube.
                </p>
                ...
                <table border="1" cellspacing="0" cellpadding="4" width="100%" style="margin-top: 8px;">
                  ...
                  <tbody>
                    <tr>
                      <td>Ctrl + O</td>
                      <td>Open a hypercube.</td>
                    </tr>
                    <tr>
                      <td>Ctrl + W</td>
                      <td>Close the hypercube.</td>
                    </tr>
                    <tr>
                      <td>Ctrl + Q</td>
                    ...
                    <tr>
                      <td>Ctrl + Plus</td>
                      <td>Zoom the image in.</td>
                    </tr>
                    <tr>
                      <td>Ctrl + Minus</td>
                      <td>Zoom the image out.</td>
                    </tr>
                    <tr>
                      <td>Ctrl + 1</td>
                      <td>Zoom the image to fit.</td>
                    </tr>
                    <tr>
                      <td>Ctrl + A</td>
                      <td>Rotate the image left.</td>
                    </tr>
                    <tr>
                      <td>Ctrl + D</td>
                      <td>Rotate the image right.</td>
                    </tr>
                    <tr>
                      <td>Ctrl + V</td>
